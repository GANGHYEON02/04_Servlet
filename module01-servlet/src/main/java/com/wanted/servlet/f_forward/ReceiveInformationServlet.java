...
public class ReceiveInformationServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        //service,login(userId,psw)
        System.out.println("로그인 완료!!!");

        /*im.
         *  사용자가 ID, PSW입력 후 로그인 버튼을 누르면
         *   /forward 요청을 처리하는 서블렛이 동작하는 것을 보았다.
         *   해당 서블릿은 사용자의 요청이 들어오면 비즈니스 로직을 처리하는 용도의
         *   책임만 갖게 한다.
        ...
        //forward 시 req객체와 resp객체를 전달해주어야 한다.
         ...
         * im.
         *  중요!!!!!!!!!!!!!!!!!!!
         *   forward는 서로 다른 서블릿과 req,resp 를 공유한다.
         ...
         *   insert 등의 DML구문은 forward방식으로 처리하면 큰일난다.
         * */
